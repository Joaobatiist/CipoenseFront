...
import { faBars, faTimes, faCalendarAlt, faChartLine, faBell, faUser, faSignOutAlt, faPlus, faIdCard, faAddressCard } from '@fortawesome/free-solid-svg-icons';
import { Button } from "../../components/button"
import { ptBR } from "../../utils/localendarConfig"
import { Calendar, LocaleConfig } from 'react-native-calendars'; 
import { router } from 'expo-router';
import { styles } from "./Supervisor"
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      {sidebarOpen && (
        <View style={styles.sidebar}>
          ...
          <TouchableOpacity style={styles.navItem} onPress={Cadastrar}>
            <FontAwesomeIcon icon={faIdCard} size={16} color="#fff" style={styles.navIcon} />
            <Text style={styles.navText}>Cadastrar funcionarios</Text>
          </TouchableOpacity>
